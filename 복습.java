...
class 자동차 {
	 ...
	 * 지불해야 할 금액을 return하도록 getMony 함수(메소드) 로직완성하기
	 */
	public int getMoney(int price) {
		// price금액이 50만원이상이면 20%할인, 30만원 이상이면 10%할인, 10만원 이상이면 5% 할인
		if(price >= 500000) {
			price *= 0.8;
	...
	*/
	...
	/*
	 * 정수를 담고 있는 arr가 파라미터로 주어졌을 때
	 * 배욜 값 중 원소가 짝수면 해당 원소를 2로 나누고 다시 해당 원소에 대입
...
public class 복습 {
	 ...
	 public static void main(String[] args) {
		 ...
		 int [] arraySum = {1, 5, 100, 50};
		 int 최종값1 = car1.getArrsum(arraySum);
		 System.out.println("최종 합 : " + 최종값1);
