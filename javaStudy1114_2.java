...
public class javaStudy1114_2 {
	...
	public static void main(String[] args) {
		...
		final double PI = 3.14; // 월주율(파이)은 3.14 -> 고정된 값을 상수라 함
		...
		// 큰 바이트크기에서 작은 바이트크기로 변환할 때는 개발자가 의도적으로 타입을 변환
	    // 해야 합니다.
		double num3 = 100.45;
		int num4 = (int)num3; // 정수형 변수 num4에 num3를 대입함 (강제 타입변환)
		System.out.println("최종 값 : " + num4); // 뒤에 소수점이 없어짐
